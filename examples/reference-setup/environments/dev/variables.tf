...
variable "alerts_triggering" {
  ...
  type        = bool
  default     = false  # Less aggressive for dev
}
...
# Slowness Alert Configuration (More lenient for dev)
...
variable "error_rate_threshold" {
  ...
  type        = number
  default     = 0.10  # More lenient for dev
}
