...
variable "alert_email_addresses" {
  ...
  type        = list(string)
  default     = ["ops@example.com", "oncall@example.com"]
}
...
# Slowness Alert Configuration (Strict production thresholds)
