...
func (test *sloConfigTest) run(t *testing.T) {
	...
	t.Run("Should Map Valid Slo Synthetic Config To API Object", test.shouldMapSyntheticSloConfigToAPIObject())
}
...
func (r *sloConfigTest) shouldMapSyntheticSloConfigToAPIObject() func(t *testing.T) {
	return func(t *testing.T) {
		...
		// Validate entity
		require.NotNil(t, apiObject.Entity, "Entity should not be nil")
		entity, ok := apiObject.Entity.(restapi.SloSyntheticEntity)
		require.True(t, ok, "Entity should be a SloSyntheticEntity")
		require.Equal(t, instana.SloConfigSyntheticEntity, entity.Type, "Entity Type should be synthetic")
