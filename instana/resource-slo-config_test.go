...
func (test *sloConfigTest) run(t *testing.T) {
	...
	t.Run("Should Map Valid Slo Config To API Object", test.shouldMapValidSloConfigToAPIObject())
...
func (r *sloConfigTest) shouldMapValidSloConfigToAPIObject() func(t *testing.T) {
    return func(t *testing.T) {
        testHelper := NewTestHelper[*restapi.SloConfig](t)
        resourceHandle := NewSloConfigResourceHandle()
        resourceData := testHelper.CreateEmptyResourceDataForResourceHandle(resourceHandle)
