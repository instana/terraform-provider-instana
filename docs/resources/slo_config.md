...
```hcl
filter_expression = "entity.name@dest EQUALS 'payments'"
...
filter_expression = "otel.attribute:'aws.rds.cluster.id'@na EQUALS 'my-cluster'"

# Website beacon metadata — name=beacon.meta, key=stage
filter_expression = "beacon.meta:'stage'@na EQUALS 'production'"
