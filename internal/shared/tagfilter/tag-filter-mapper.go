...
type Mapper interface {
	FromAPIModel(input *instana.TagFilter) (*FilterExpression, error)
	ToAPIModel(input *FilterExpression) *instana.TagFilter
}
...
func MapTagFilterToNormalizedString(element *instana.TagFilter) (*string, error) {
	mapper := NewMapper()
