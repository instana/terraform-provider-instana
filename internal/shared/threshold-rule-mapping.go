...
func MapThresholdsPluginFromState(ctx context.Context, thresholdStruct *ThresholdPluginModel) (map[instana.AlertSeverity]instana.ThresholdRule, diag.Diagnostics) {
	...
	if thresholdStruct != nil {
		...
		if thresholdStruct.Warning != nil {
			...
			if warningThreshold != nil {
				thresholdMap[instana.WarningSeverity] = *warningThreshold
			}
		}
		...
		if thresholdStruct.Critical != nil {
			...
			if criticalThreshold != nil {
				thresholdMap[instana.CriticalSeverity] = *criticalThreshold
			}
		}
	}
...
func MapThresholdRulePluginFromState(ctx context.Context, thresholdObj *ThresholdTypeModel) (*instana.ThresholdRule, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if thresholdObj.AdaptiveBaseline != nil {
		...
		seasonality := instana.ThresholdSeasonality(adaptiveVal.Seasonality.ValueString())
...
func MapThresholdsAllPluginFromState(ctx context.Context, thresholdStruct *ThresholdAllPluginModel) (map[instana.AlertSeverity]instana.ThresholdRule, diag.Diagnostics) {
	var diags diag.Diagnostics
	thresholdMap := make(map[instana.AlertSeverity]instana.ThresholdRule)
	if thresholdStruct != nil {
		// Process warning threshold
...
// MapThresholdRulePluginFromState maps a threshold rule from Terraform state to API model - used for new plugin model using nestedAttribute
func MapThresholdRuleAllPluginFromState(ctx context.Context, thresholdObj *ThresholdAllTypeModel) (*instana.ThresholdRule, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if thresholdObj.HistoricBaseline != nil {
		...
		seasonality := instana.ThresholdSeasonality(baselineVal.Seasonality.ValueString())
...
func MapBaselineToState(threshold *instana.ThresholdRule) (basetypes.ListValue, diag.Diagnostics) {
...
func MapThresholdPluginToState(ctx context.Context, threshold *instana.ThresholdRule, dataPresent bool) *ThresholdTypeModel {
...
// MapThresholdToState maps a threshold rule to a Terraform state representation - used for nested attribute instead of block object
func MapAllThresholdPluginToState(ctx context.Context, threshold *instana.ThresholdRule, dataPresent bool) *ThresholdAllTypeModel {
