...
// TestNewAutomationActionResourceHandleFramework tests the resource initialization
func TestNewAutomationActionResourceHandleFramework(t *testing.T) {
	resource := NewAutomationActionResourceHandleFramework()
	require.NotNil(t, resource)

	metaData := resource.MetaData()
	assert.Equal(t, ResourceInstanaAutomationActionFramework, metaData.ResourceName)
...
func TestMetaData(t *testing.T) {
	resource := &automationActionResourceFramework{
...
func TestMapStateToDataObject_FromState(t *testing.T) {
	resource := NewAutomationActionResourceHandleFramework().(*automationActionResourceFramework)
	ctx := context.Background()
