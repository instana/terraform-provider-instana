...
func TestMapEmailChannelFromState(t *testing.T) {
	...
	assert.Equal(t, instana.EmailChannelType, channel.Kind)
...
func TestMapOpsGenieChannelFromState(t *testing.T) {
	...
	assert.Equal(t, "test-id", channel.ID)
	assert.Equal(t, "test-name", channel.Name)
	assert.Equal(t, instana.OpsGenieChannelType, channel.Kind)
...
func TestMapPagerDutyChannelFromState(t *testing.T) {
	...
	assert.Equal(t, "test-id", channel.ID)
	assert.Equal(t, "test-name", channel.Name)
	assert.Equal(t, instana.PagerDutyChannelType, channel.Kind)
...
func TestMapSlackChannelFromState(t *testing.T) {
	...
	t.Run("with all fields", func(t *testing.T) {
		...
		assert.Equal(t, "test-id", channel.ID)
		assert.Equal(t, "test-name", channel.Name)
		assert.Equal(t, instana.SlackChannelType, channel.Kind)
...
func TestMapSplunkChannelFromState(t *testing.T) {
	...
	assert.Equal(t, "test-id", channel.ID)
	assert.Equal(t, "test-name", channel.Name)
	assert.Equal(t, instana.SplunkChannelType, channel.Kind)
...
func TestMapVictorOpsChannelFromState(t *testing.T) {
	...
	assert.Equal(t, "test-id", channel.ID)
	assert.Equal(t, "test-name", channel.Name)
	assert.Equal(t, instana.VictorOpsChannelType, channel.Kind)
	assert.Equal(t, "test-api-key", *channel.APIKey)
...
func TestMapWebhookChannelFromState(t *testing.T) {
	...
	t.Run("with headers", func(t *testing.T) {
		...
		assert.Equal(t, "test-id", channel.ID)
		assert.Equal(t, "test-name", channel.Name)
		assert.Equal(t, instana.WebhookChannelType, channel.Kind)
...
func TestMapWebhookBasedChannelFromState(t *testing.T) {
	...
	t.Run("Office365", func(t *testing.T) {
		channel, diags := resource.mapWebhookBasedChannelFromState(ctx, "test-id", "test-name", webhookBasedModel, instana.Office365ChannelType)
		require.False(t, diags.HasError())
		require.NotNil(t, channel)
		assert.Equal(t, instana.Office365ChannelType, channel.Kind)
		assert.Equal(t, "https://webhook.example.com", *channel.WebhookURL)
	})

	t.Run("GoogleChat", func(t *testing.T) {
		channel, diags := resource.mapWebhookBasedChannelFromState(ctx, "test-id", "test-name", webhookBasedModel, instana.GoogleChatChannelType)
		require.False(t, diags.HasError())
		require.NotNil(t, channel)
		assert.Equal(t, instana.GoogleChatChannelType, channel.Kind)
	})

	t.Run("WebexTeamsWebhook", func(t *testing.T) {
		channel, diags := resource.mapWebhookBasedChannelFromState(ctx, "test-id", "test-name", webhookBasedModel, instana.WebexTeamsWebhookChannelType)
		require.False(t, diags.HasError())
		require.NotNil(t, channel)
		assert.Equal(t, instana.WebexTeamsWebhookChannelType, channel.Kind)
	})
}
...
func TestMapServiceNowChannelFromState(t *testing.T) {
	...
	t.Run("with all fields", func(t *testing.T) {
		...
		require.False(t, diags.HasError())
		require.NotNil(t, channel)
		assert.Equal(t, instana.ServiceNowChannelType, channel.Kind)
...
func TestMapServiceNowApplicationChannelFromState(t *testing.T) {
	...
	t.Run("with all fields", func(t *testing.T) {
		...
		require.False(t, diags.HasError())
		require.NotNil(t, channel)
		assert.Equal(t, instana.ServiceNowApplicationChannelType, channel.Kind)
		assert.Equal(t, "https://servicenow.example.com", *channel.ServiceNowURL)
		assert.Equal(t, "test-user", *channel.Username)
		assert.Equal(t, "test-password", *channel.Password)
...
func TestMapPrometheusWebhookChannelFromState(t *testing.T) {
	...
	t.Run("with receiver", func(t *testing.T) {
		...
		require.False(t, diags.HasError())
		require.NotNil(t, channel)
		assert.Equal(t, instana.PrometheusWebhookChannelType, channel.Kind)
...
func TestMapWatsonAIOpsWebhookChannelFromState(t *testing.T) {
	...
	t.Run("with headers", func(t *testing.T) {
		...
		require.False(t, diags.HasError())
		require.NotNil(t, channel)
		assert.Equal(t, instana.WatsonAIOpsWebhookChannelType, channel.Kind)
...
func TestUpdateState(t *testing.T) {
	...
	t.Run("Email channel", func(t *testing.T) {
		resource := &alertingChannelResource{}
		apiChannel := &instana.AlertingChannel{
			ID:     "test-id",
			Name:   "test-name",
	...
	t.Run("Office365 channel", func(t *testing.T) {
		...
		apiChannel := &instana.AlertingChannel{
			ID:         "test-id",
			Name:       "test-name",
			Kind:       instana.Office365ChannelType,
			WebhookURL: &webhookURL,
		}
	...
	t.Run("GoogleChat channel", func(t *testing.T) {
		...
		apiChannel := &instana.AlertingChannel{
			ID:         "test-id",
			Name:       "test-name",
			Kind:       instana.GoogleChatChannelType,
			WebhookURL: &webhookURL,
		}
	...
	t.Run("WebexTeamsWebhook channel", func(t *testing.T) {
		...
		apiChannel := &instana.AlertingChannel{
			ID:         "test-id",
			Name:       "test-name",
			Kind:       instana.WebexTeamsWebhookChannelType,
			WebhookURL: &webhookURL,
		}
	...
	t.Run("Unsupported channel type", func(t *testing.T) {
		...
		apiChannel := &instana.AlertingChannel{
			ID:   "test-id",
			Name: "test-name",
			Kind: instana.AlertingChannelType("UNSUPPORTED"),
		}
