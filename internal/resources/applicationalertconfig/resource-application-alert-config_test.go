...
func TestResourceImpl_GetID(t *testing.T) {
	...
	data := &instana.ApplicationAlertConfig{
		ID: "test-id-123",
	}
...
func TestMapStateToDataObject_BasicConfig(t *testing.T) {
	...
	assert.Equal(t, instana.ApplicationAlertEvaluationType("PER_AP"), result.EvaluationType)
...
func TestUpdateState_BasicConfig(t *testing.T) {
	...
	data := &instana.ApplicationAlertConfig{
		...
		Applications:     map[string]instana.IncludedApplication{},
		Rules:            []instana.ApplicationAlertRuleWithThresholds{},
	}
	...
	data := &instana.ApplicationAlertConfig{
		...
		Applications: map[string]instana.IncludedApplication{
			"app-1": {
				ApplicationID: "app-1",
				Inclusive:     true,
				Services: map[string]instana.IncludedService{
					"svc-1": {
						ServiceID: "svc-1",
						Inclusive: true,
						Endpoints: map[string]instana.IncludedEndpoint{
							"ep-1": {
								EndpointID: "ep-1",
								Inclusive:  true,
							},
...
func TestUpdateState_WithTimeThreshold(t *testing.T) {
	t.Run("request_impact", func(t *testing.T) {
		...
		data := &instana.ApplicationAlertConfig{
			...
			Applications:     map[string]instana.IncludedApplication{},
			Rules:            []instana.ApplicationAlertRuleWithThresholds{},
			TimeThreshold: &instana.ApplicationAlertTimeThreshold{
				Type:       "requestImpact",
				TimeWindow: 600000,
				Requests:   100,
			},
...
func TestMapStateToDataObject_WithStaticThreshold(t *testing.T) {
	...
	require.NotNil(t, result)
	require.Len(t, result.Rules, 1)
	require.Contains(t, result.Rules[0].Thresholds, instana.WarningSeverity)
	assert.Equal(t, "staticThreshold", result.Rules[0].Thresholds[instana.WarningSeverity].Type)
	require.NotNil(t, result.Rules[0].Thresholds[instana.WarningSeverity].Value)
	assert.Equal(t, float64(100), *result.Rules[0].Thresholds[instana.WarningSeverity].Value)
}
...
func TestUpdateState_WithRulesAndThresholds(t *testing.T) {
	...
	data := &instana.ApplicationAlertConfig{
		...
		Rules: []instana.ApplicationAlertRuleWithThresholds{
			{
				Rule: &instana.ApplicationAlertRule{
	...
	tests := []struct {
		...
		},
		{
			...
			rule: &instana.ApplicationAlertRule{
				...
				MetricName:  "logs",
				Aggregation: "sum",
				Level:       ptr(instana.LogLevelError),
				Message:     ptr("test message"),
				Operator:    ptr(instana.ContainsOperator),
			},
		},
		{
			name: "slowness_rule",
...
func TestWrapperMapStateToDataObject_WithState(t *testing.T) {
	...
	assert.Equal(t, instana.BoundaryScope("INBOUND"), result.BoundaryScope)
...
func TestMapStateToDataObject_AllBoundaryScopes(t *testing.T) {
	...
	for _, scope := range scopes {
		t.Run(scope, func(t *testing.T) {
			...
			require.False(t, diags.HasError())
			require.NotNil(t, result)
			assert.Equal(t, instana.BoundaryScope(scope), result.BoundaryScope)
		})
	}
}
...
func TestMapStateToDataObject_WithCriticalThreshold(t *testing.T) {
	...
	require.NotNil(t, result)
	require.Len(t, result.Rules, 1)
	require.Contains(t, result.Rules[0].Thresholds, instana.CriticalSeverity)
	assert.Equal(t, "staticThreshold", result.Rules[0].Thresholds[instana.CriticalSeverity].Type)
	require.NotNil(t, result.Rules[0].Thresholds[instana.CriticalSeverity].Value)
	assert.Equal(t, float64(200), *result.Rules[0].Thresholds[instana.CriticalSeverity].Value)
}
...
func TestMapStateToDataObject_WithAdaptiveBaselineThreshold(t *testing.T) {
	...
	threshold := result.Rules[0].Thresholds[instana.WarningSeverity]
...
func TestMapStateToDataObject_WithAdaptiveBaselineCriticalThreshold(t *testing.T) {
	...
	threshold := result.Rules[0].Thresholds[instana.CriticalSeverity]
	assert.Equal(t, "adaptiveBaseline", threshold.Type)
	require.NotNil(t, threshold.DeviationFactor)
	...
	require.NotNil(t, threshold.Seasonality)
	assert.Equal(t, instana.ThresholdSeasonality("WEEKLY"), *threshold.Seasonality)
}
...
func TestUpdateState_WithMixedThresholds(t *testing.T) {
	...
	criticalSeasonality := instana.ThresholdSeasonality("WEEKLY")
...
func TestMapStateToDataObject_WithNullAdaptiveBaselineFields(t *testing.T) {
	...
	require.NotNil(t, threshold.Seasonality)
	assert.Equal(t, instana.ThresholdSeasonality(""), *threshold.Seasonality)
}
...
func TestMapStateToDataObject_WithBothAdaptiveBaselineThresholds(t *testing.T) {
	...
	warningThreshold := result.Rules[0].Thresholds[instana.WarningSeverity]
	...
	assert.Equal(t, instana.ThresholdSeasonality("DAILY"), *warningThreshold.Seasonality)

	// Check critical threshold
	criticalThreshold := result.Rules[0].Thresholds[instana.CriticalSeverity]
	...
	assert.Equal(t, instana.ThresholdSeasonality("WEEKLY"), *criticalThreshold.Seasonality)
}
...
func TestUpdateState_EnabledField(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			apiData := &instana.ApplicationAlertConfig{
				ID:               "test-id",
				Name:             "Test Alert",
				Description:      "Test Description",
				BoundaryScope:    "ALL",
