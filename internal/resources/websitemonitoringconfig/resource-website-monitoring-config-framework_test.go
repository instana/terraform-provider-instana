...
func TestNewWebsiteMonitoringConfigResourceHandleFramework(t *testing.T) {
	t.Run("should create resource handle with correct metadata", func(t *testing.T) {
		handle := NewWebsiteMonitoringConfigResourceHandleFramework()

		assert.NotNil(t, handle)
		assert.NotNil(t, handle.MetaData())
		assert.Equal(t, ResourceInstanaWebsiteMonitoringConfigFramework, handle.MetaData().ResourceName)
...
func TestMetaData(t *testing.T) {
	resource := &websiteMonitoringConfigResourceFramework{
	...
	t.Run("should return metadata", func(t *testing.T) {
		...
		assert.Equal(t, ResourceInstanaWebsiteMonitoringConfigFramework, metaData.ResourceName)
...
func TestMapStateToDataObject(t *testing.T) {
	resource := &websiteMonitoringConfigResourceFramework{
		metaData: resourcehandle.ResourceMetaDataFramework{
			ResourceName:  ResourceInstanaWebsiteMonitoringConfigFramework,
			Schema:        NewWebsiteMonitoringConfigResourceHandleFramework().MetaData().Schema,
			SchemaVersion: 1,
		},
	}
	ctx := context.Background()
...
func TestGetRestResource_WithMockAPI(t *testing.T) {
	resource := NewWebsiteMonitoringConfigResourceHandleFramework()
