...
const (
	...
	// MobileAlertConfigFieldTimeThresholdUserImpactMeasurementMethod constant value for field time_threshold.user_impact_of_violations_in_sequence.impact_measurement_method
	MobileAlertConfigFieldTimeThresholdUserImpactMeasurementMethod = "impact_measurement_method"
...
const (
	...
	MobileAlertConfigDescTimeThresholdImpactMeasurementMethod = "The method to measure user impact. Valid values: AGGREGATED, PER_WINDOW."
