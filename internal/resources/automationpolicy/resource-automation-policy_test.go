...
// TestNewAutomationPolicyResourceHandle tests the resource initialization
func TestNewAutomationPolicyResourceHandle(t *testing.T) {
	resource := NewAutomationPolicyResourceHandle()
	require.NotNil(t, resource)

	metaData := resource.MetaData()
	assert.Equal(t, ResourceInstanaAutomationPolicy, metaData.ResourceName)
...
func TestMapStateToDataObject_WithScheduling(t *testing.T) {
	...
	assert.Equal(t, api.DurationUnit("MINUTE"), result.Trigger.Scheduling.DurationUnit)
...
func TestUpdateState_BasicPolicy(t *testing.T) {
	...
	data := &api.AutomationPolicy{
		...
		TypeConfigurations: []api.TypeConfiguration{
			{
				Name:      "manual",
				Condition: &api.Condition{Query: ""},
...
func TestMapTypeConfigurationsToState(t *testing.T) {
	...
	typeConfigs := []api.TypeConfiguration{
		{
			Name: "manual",
			Condition: &api.Condition{
				Query: "entity.type:service",
			...
			Actions: []api.AutomationActionPolicy{
				...
				},
				{
					Action: api.AutomationAction{
						...
						Type:            "manual",
						Fields:          []api.Field{{Name: "content", Value: "Content"}},
						InputParameters: []api.Parameter{},
					},
					AgentId: "",
				},
...
func createMinimalRestAPIAction() api.AutomationAction {
