...
type APITokenModel struct {
	...
	CanCollectNetTraceLogs                               types.Bool `tfsdk:"can_collect_net_trace_logs"`
	...
	CanConfigureCustomEntities                           types.Bool `tfsdk:"can_configure_custom_entities"`
	CanConfigureWebsiteConversions                       types.Bool `tfsdk:"can_configure_website_conversions"`
	CanConfigureIPFiltering                              types.Bool `tfsdk:"can_configure_ip_filtering"`
	CanConfigureLlmModelPrice                            types.Bool `tfsdk:"can_configure_llm_model_price"`
	CanConfigurePersonallyIdentifiableInformationMasking types.Bool `tfsdk:"can_configure_personally_identifiable_information_masking"`
	CanDownloadAgentConfiguration                        types.Bool `tfsdk:"can_download_agent_configuration"`
