...
func TestNewCustomEventSpecificationResourceHandleFramework(t *testing.T) {
	resource := NewCustomEventSpecificationResourceHandleFramework()
	require.NotNil(t, resource)

	metaData := resource.MetaData()
	assert.Equal(t, ResourceInstanaCustomEventSpecificationFramework, metaData.ResourceName)
...
func TestSchemaValidation(t *testing.T) {
	handle := NewCustomEventSpecificationResourceHandleFramework()
