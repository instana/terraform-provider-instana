...
// DataSourceInstanaAlertingChannel the name of the terraform-provider-instana data source to read alerting channel
const DataSourceInstanaAlertingChannel = "alerting_channel"
...
func NewAlertingChannelDataSource() datasource.DataSource {
...
func (d *AlertingChannelDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + DataSourceInstanaAlertingChannel
}

func (d *AlertingChannelDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *AlertingChannelDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AlertingChannelDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var matchingChannel *instana.AlertingChannel
	...
	//resourceHandle := NewAlertingChannelResourceHandle().(*alertingChannelResource)
